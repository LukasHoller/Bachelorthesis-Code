...
# Variables that are saved during the reconstruction
...
variables.variables.addAlias('p_cms', 'useCMSFrame(p)')

var_kin = ['E', 'theta', 'phi', 'p', 'p_cms', 'M', 'InvM', 'dM', 'px', 'py', 'pz']

var_mother = ['genMotherPDG', 'genMotherPDG(1)']

var_cluster = ['clusterE9E21', 'clusterE9E25', 'b2bClusterPhi', 'b2bClusterTheta', 'clusterE9E21', 'clusterE9E25','clusterAbsZernikeMoment40', 'clusterAbsZernikeMoment51', 'clusterE', 'clusterE1E9', 'clusterEoP', 'clusterErrorE', 'clusterErrorTheta', 'clusterErrorTiming', 'clusterLAT', 'clusterPhi', 'clusterSecondMoment', 'clusterTheta', 'clusterTiming', 'clusterZernikeMVA', 'clusterTiming', 'clusterErrorPhi', 'ECLClusterE_uncertainty']

var_other = ['E_uncertainty', 'ImpactXY', 'b2bPhi', 'b2bTheta', 'cosAngleBetweenMomentumAndVertexVector', 'cosAngleBetweenMomentumAndVertexVectorInXYPlane', 'cosTheta', 'cosThetaErr', 'pErr', 'pRecoil', 'pRecoilPhi', 'pRecoilTheta', 'phiErr', 'pt', 'ptErr', 'pxErr', 'pyErr', 'pzErr', 'pxRecoil', 'pyRecoil', 'pzRecoil', 'minC2TDist']
